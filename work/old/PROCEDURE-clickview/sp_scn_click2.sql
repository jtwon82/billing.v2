...
DROP PROCEDURE IF EXISTS `sp_scn_click2`$$

CREATE PROCEDURE `sp_scn_click2`(
...
BEGIN
	-- sp_status_scn 에서 sp_scn_click 로 변경
	-- 쇼플에 대한 클릭을 처리하는 프로시져
	...
	-- 	UPDATE iadsite SET usedmoney=usedmoney+$POINT WHERE site_code=$site_code;
	-- END IF;
