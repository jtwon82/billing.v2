...
@Repository
public class IntgCntrDataDao {

	private static final Logger	logger	= LoggerFactory.getLogger(IntgCntrDataDao.class);

	public static final String	NAMESPACE	= "intgCntrDataMapper";
			...
			public Object doInTransaction(TransactionStatus status) {
				try {
					...
					for (Entry<String, ArrayList<BaseCVData>> item : flushMap.entrySet()) {
						...
						logger.debug("IntgCntr dataKey - {}", dataKey);
						logger.debug("IntgCntr dataSize - {}", dataSize);
