...
//	@Bean (destroyMethod = "close")
//	@ConfigurationProperties(prefix = "spring.datasource.billing-kwrd")
//	public DataSource dataSourceBillingKwrd() {
//		DataSource result = DataSourceBuilder.create().build();
//		return result;
//	}
	@Bean (destroyMethod = "close")
	...
	@Bean (destroyMethod = "close")
	@ConfigurationProperties(prefix = "spring.datasource.openrtb")
	public DataSource dataSourceOpenrtb() {
		DataSource result = DataSourceBuilder.create().build();
		return result;
	}
	...
	@Bean(name="sqlSessionFactoryConvBilling")
	public SqlSessionFactory sqlSessionFactoryConvBilling() throws Exception {
	...
	@Bean(name="sqlSessionFactoryConvDream")
	public SqlSessionFactory sqlSessionFactoryConvDream() throws Exception {
		SqlSessionFactoryBean sqlSessionFactory = new SqlSessionFactoryBean();
...
//	@Bean(name="sqlSessionFactoryBillingKwrd")
//	public SqlSessionFactory sqlSessionFactoryBillingKwrd() throws Exception {
//		SqlSessionFactoryBean sqlSessionFactory = new SqlSessionFactoryBean();
//		sqlSessionFactory.setDataSource(dataSourceBillingKwrd());
//		PathMatchingResourcePatternResolver resourcePatternResolver = new PathMatchingResourcePatternResolver();
//		DefaultResourceLoader defaultResourceLoader = new DefaultResourceLoader();
//		sqlSessionFactory.setConfigLocation(defaultResourceLoader.getResource("classpath:mybatis/mybatis-config.xml"));
//		sqlSessionFactory.setMapperLocations(resourcePatternResolver.getResources("classpath:mapper/*.xml"));
...
//	}
	...
	@Bean(name="sqlSessionFactoryOpenrtb")
	public SqlSessionFactory sqlSessionFactoryOpenrtb() throws Exception {
		SqlSessionFactoryBean sqlSessionFactory = new SqlSessionFactoryBean();
		sqlSessionFactory.setDataSource(dataSourceOpenrtb());
		PathMatchingResourcePatternResolver resourcePatternResolver = new PathMatchingResourcePatternResolver();
		DefaultResourceLoader defaultResourceLoader = new DefaultResourceLoader();
		sqlSessionFactory.setConfigLocation(defaultResourceLoader.getResource("classpath:mybatis/mybatis-config.xml"));
		sqlSessionFactory.setMapperLocations(resourcePatternResolver.getResources("classpath:mapper/*.xml"));
	...
	@Bean(name = "sqlSessionTemplateConvBilling", destroyMethod = "clearCache")
	public SqlSessionTemplate sqlSessionTemplateConvBilling() throws Exception {
		return new SqlSessionTemplate(sqlSessionFactoryConvBilling(), ExecutorType.SIMPLE);
	}
	@Bean(name = "sqlSessionTemplateConvDream", destroyMethod = "clearCache")
	public SqlSessionTemplate sqlSessionTemplateConvDream() throws Exception {
		return new SqlSessionTemplate(sqlSessionFactoryConvDream(), ExecutorType.SIMPLE);
	}
...
//	@Bean(name = "sqlSessionTemplateBillingKwrd", destroyMethod = "clearCache")
//	public SqlSessionTemplate sqlSessionTemplateBillingKwrd() throws Exception {
//		return new SqlSessionTemplate(sqlSessionFactoryBillingKwrd(), ExecutorType.BATCH);
//	}
	...
	@Bean(name = "sqlSessionTemplateBillingSIMPLE", destroyMethod = "clearCache")
	public SqlSessionTemplate sqlSessionTemplateBillingSIMPLE() throws Exception {
	...
	@Bean(name = "sqlSessionTemplateOpenrtb", destroyMethod = "clearCache")
	public SqlSessionTemplate sqlSessionTemplateOpenrtb() throws Exception {
		return new SqlSessionTemplate(sqlSessionFactoryOpenrtb(), ExecutorType.BATCH);
	}
