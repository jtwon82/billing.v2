					...
					try {
						...
						while( (line = reader.readLine()) != null){
							...
							if( contextClosedHandler.closed ) {
								...
								if( "UseridVo".equals( topic ) ) {
									try {
										UseridVo obj = new ObjectMapper().readValue(msg, UseridVo.class);
										sumObjectManager.appendUseridVo(obj);
