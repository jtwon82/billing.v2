package com.mobon.billing.branch.config;

import java.util.HashMap;
import java.util.Map;

import com.mobon.billing.branch.consumer.ConsumerBranch;
...
public class KafkaConfig {
	...
	public ConcurrentKafkaListenerContainerFactory<String, String> kafkaListenerContainerFactory() {
		...
		factory.getContainerProperties().setMessageListener(new ConsumerBranch());
