...
@Configuration
@Service
public class MongoShopLog_dTask extends MongoShopLogTask {
	...
	public static String[] DIR = new String[] {"d"};
...
//				PackageKeyTask.START_SHOP_LOG = true;
			...
			for(int i=0; i<DIR.length; i++) {
				read.read(MongoShopLog_dTask.PARTITION+"/"+DIR[i], new ReadADID.IADID() {
					@Override
