...
@Configuration
@Service
public class MongoShopLog_cTask extends MongoShopLogTask {
	...
	public static String[] DIR = new String[] {"c"};
...
//				PackageKeyTask.START_SHOP_LOG = true;
			...
			for(int i=0; i<DIR.length; i++) {
				read.read(MongoShopLog_cTask.PARTITION+"/"+DIR[i], new ReadADID.IADID() {
					@Override
