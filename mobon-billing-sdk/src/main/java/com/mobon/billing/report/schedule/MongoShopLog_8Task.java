...
@Configuration
@Service
public class MongoShopLog_8Task extends MongoShopLogTask {
	...
	public static String[] DIR = new String[] {"8"};
...
//				PackageKeyTask.START_SHOP_LOG = true;
			...
			for(int i=0; i<DIR.length; i++) {
				read.read(MongoShopLog_8Task.PARTITION+"/"+DIR[i], new ReadADID.IADID() {
					@Override
