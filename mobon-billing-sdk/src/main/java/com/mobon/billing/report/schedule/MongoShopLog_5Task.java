...
@Configuration
@Service
public class MongoShopLog_5Task extends MongoShopLogTask {
	...
	public static String[] DIR = new String[] {"5"};
...
//				PackageKeyTask.START_SHOP_LOG = true;
			...
			for(int i=0; i<DIR.length; i++) {
				read.read(MongoShopLog_5Task.PARTITION+"/"+DIR[i], new ReadADID.IADID() {
					@Override
