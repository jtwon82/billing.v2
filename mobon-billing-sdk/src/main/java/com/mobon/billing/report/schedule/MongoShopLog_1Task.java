...
@Configuration
@Service
public class MongoShopLog_1Task extends MongoShopLogTask {
...
//	public static String PARTITION = "C:/workset/workspace_consumer/mobon-billing-v1/mobon-billing-sdk";
	
	public static String[] DIR = new String[] {"1"};
...
//				PackageKeyTask.START_SHOP_LOG = true;
			...
			logger.info(Thread.currentThread().getName() + "-disk scan start.....");
			
			for(int i=0; i<DIR.length; i++) {
				read.read(MongoShopLog_1Task.PARTITION+"/"+DIR[i], new ReadADID.IADID() {
					@Override
