...
@Configuration
@Service
public class MongoShopLog_aTask extends MongoShopLogTask {
	...
	public static String[] DIR = new String[] {"a"};
...
//				PackageKeyTask.START_SHOP_LOG = true;
			...
			for(int i=0; i<DIR.length; i++) {
				read.read(MongoShopLog_aTask.PARTITION+"/"+DIR[i], new ReadADID.IADID() {
					@Override
