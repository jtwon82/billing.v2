...
@Configuration
@Service
public class MongoShopLog_4Task extends MongoShopLogTask {
	...
	public static String[] DIR = new String[] {"4"};
...
//				PackageKeyTask.START_SHOP_LOG = true;
			...
			for(int i=0; i<DIR.length; i++) {
				read.read(MongoShopLog_4Task.PARTITION+"/"+DIR[i], new ReadADID.IADID() {
					@Override
