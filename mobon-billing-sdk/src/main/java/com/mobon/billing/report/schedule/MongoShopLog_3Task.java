...
@Configuration
@Service
public class MongoShopLog_3Task extends MongoShopLogTask {
	...
	public static String[] DIR = new String[] {"3"};
...
//				PackageKeyTask.START_SHOP_LOG = true;
			...
			for(int i=0; i<DIR.length; i++) {
				read.read(MongoShopLog_3Task.PARTITION+"/"+DIR[i], new ReadADID.IADID() {
					@Override
