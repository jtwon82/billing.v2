...
@Configuration
@Service
public class MongoShopLog_2Task extends MongoShopLogTask {
	...
	public static String[] DIR = new String[] {"2"};
...
//				PackageKeyTask.START_SHOP_LOG = true;
			...
			for(int i=0; i<DIR.length; i++) {
				read.read(MongoShopLog_2Task.PARTITION+"/"+DIR[i], new ReadADID.IADID() {
					@Override
