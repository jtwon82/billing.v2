...
@Configuration
@Service
public class MongoShopLog_eTask extends MongoShopLogTask {
	...
	public static String[] DIR = new String[] {"e"};
...
//				PackageKeyTask.START_SHOP_LOG = true;
			...
			for(int i=0; i<DIR.length; i++) {
				read.read(MongoShopLog_eTask.PARTITION+"/"+DIR[i], new ReadADID.IADID() {
					@Override
