...
@Configuration
@Service
public class MongoShopLog_0Task extends MongoShopLogTask {
	...
	private static final Logger logger = LoggerFactory.getLogger(MongoShopLog_0Task.class);
	
	public static String PARTITION = "../packaging/data";
	
	public static String[] DIR = new String[] {"0"};
...
//				PackageKeyTask.START_SHOP_LOG = true;
			...
			for(int i=0; i<DIR.length; i++) {
				read.read(MongoShopLog_0Task.PARTITION+"/"+DIR[i], new ReadADID.IADID() {
					@Override
