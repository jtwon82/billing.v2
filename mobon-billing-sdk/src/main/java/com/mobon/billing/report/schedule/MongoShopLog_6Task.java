...
@Configuration
@Service
public class MongoShopLog_6Task extends MongoShopLogTask {
	...
	public static String[] DIR = new String[] {"6"};
...
//				PackageKeyTask.START_SHOP_LOG = true;
			...
			for(int i=0; i<DIR.length; i++) {
				read.read(MongoShopLog_6Task.PARTITION+"/"+DIR[i], new ReadADID.IADID() {
					@Override
