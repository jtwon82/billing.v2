...
@Configuration
@Service
public class MongoShopLog_bTask extends MongoShopLogTask {
	...
	public static String[] DIR = new String[] {"b"};
...
//				PackageKeyTask.START_SHOP_LOG = true;
			...
			for(int i=0; i<DIR.length; i++) {
				read.read(MongoShopLog_bTask.PARTITION+"/"+DIR[i], new ReadADID.IADID() {
					@Override
