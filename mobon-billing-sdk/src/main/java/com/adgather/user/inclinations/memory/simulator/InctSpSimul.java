 ...
 *
 */
public class InctSpSimul extends InctShopsSimul {
	private static final Logger logger = Logger.getLogger(InctSpSimul.class);
	
	public InctSpSimul(MemoryObj<OldInctShopLog> refactMemoryObject) {
	...
	protected boolean isTargetShopLog(OldInctShopLog obj) {
		...
		return InctShopsCtr.isSpShopLog(obj);
	}
}
