...
public class MInctUM
	...
	public MInctUM(String cookieValue) throws Exception {
		setCookieValue(cookieValue);
	}
	
	public MInctUM(Document mongoDoc) throws Exception {
		setMongoValue(mongoDoc);
	}
	
	public MInctUM(MInctUM obj) {
		this.pkg = obj.pkg;
	...
	@Override
	public MInctUM clone() throws CloneNotSupportedException {
		// TODO Auto-generated method stub
		return new MInctUM(this);
	}
	...
	public void modValue(	Object element,
		...
		// TODO Auto-generated method stub
		if(!(element instanceof MInctUM))		return;
