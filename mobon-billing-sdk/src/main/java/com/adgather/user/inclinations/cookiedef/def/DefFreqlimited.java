...
public class DefFreqlimited extends CookieDef {
    public DefFreqlimited(String cookieKey) {
        super(cookieKey);
    }
    ...
    public int getExpire() {
        return PropertyHandler.getInt("COOKIE_FREQ_LIMITED_EXPIRE");
    }

    @Override
    public void infuseLimit(MemoryObj<?> memoryObj) {
        memoryObj.setCookieMaxCnt(PropertyHandler.getInt("COOKIE_FREQ_LIMITED_COUNT"));
        memoryObj.setCookieMaxLen(PropertyHandler.getInt("COOKIE_FREQ_LIMITED_BYTES"));
    }
