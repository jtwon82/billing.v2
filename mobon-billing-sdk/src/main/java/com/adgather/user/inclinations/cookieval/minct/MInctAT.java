...
public class MInctAT
	...
	public MInctAT(String cookieValue) throws Exception {
		setCookieValue(cookieValue);
	}
	
	public MInctAT(Document mongoDoc) throws Exception {
		setMongoValue(mongoDoc);
	}
	
	public MInctAT(MInctAT obj) {
		this.pkg = obj.pkg;
...
//		System.out.println(cookieValue);
	...
	@Override
	public MInctAT clone() throws CloneNotSupportedException {
		// TODO Auto-generated method stub
		return new MInctAT(this);
	}
	...
	public void modValue(	Object element,
		...
		// TODO Auto-generated method stub
		if(!(element instanceof MInctAT))		return;
