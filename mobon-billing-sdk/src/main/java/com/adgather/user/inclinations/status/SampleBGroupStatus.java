 ...
 *
 */
public class SampleBGroupStatus {
	/** 테스트 설정 상태**/
	...
	/** 기본설정 **********************************************************************************/
	public void setSampleBGroupABTest(ConsumerInclinations inclination) {
//		InfoAbTest sampleBGroupABTest = checkType(inclination, SampleBGroupTest.TEST_NAME, SampleBGroupTest.SAMPLE_B, SampleBGroupTest.SAMPLE_B[0]);
//		if(sampleBGroupABTest != null) {
//			testTypes.put(sampleBGroupABTest.getTesting(), sampleBGroupABTest.getType());
//		}
	}
...
//		if(SampleBGroupTest.isActive()) {			//AB테스트 인 경우
