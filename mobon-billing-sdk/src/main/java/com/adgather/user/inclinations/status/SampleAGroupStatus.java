...
//import com.adgather.abtest.SampleAGroupTest;
 ...
 *
 */
public class SampleAGroupStatus {
	/** 테스트 설정 상태**/
	...
	/** 기본설정 **********************************************************************************/
	public void setSampleAGroupABTest(ConsumerInclinations inclination) {
//		InfoAbTest sampleAGroupABTest = checkType(inclination, SampleAGroupTest.TEST_NAME, SampleAGroupTest.SAMPLE_A, SampleAGroupTest.SAMPLE_A[0]);
//		if(sampleAGroupABTest != null) {
//			testTypes.put(sampleAGroupABTest.getTesting(), sampleAGroupABTest.getType());
//		}
	}
...
//		if(SampleAGroupTest.isActive()) {			//AB테스트 인 경우
