...
public class MInctHU
	...
	public MInctHU(String cookieValue) throws Exception {
		setCookieValue(cookieValue);
	}
	
	public MInctHU(Document mongoDoc) throws Exception {
		setMongoValue(mongoDoc);
	}
	
	public MInctHU(MInctHU obj) {
		this.pkg = obj.pkg;
...
//		System.out.println(cookieValue);
	...
	@Override
	public MInctHU clone() throws CloneNotSupportedException {
		// TODO Auto-generated method stub
		return new MInctHU(this);
	}
	...
	public void modValue(	Object element,
		...
		// TODO Auto-generated method stub
		if(!(element instanceof MInctHU))		return;
