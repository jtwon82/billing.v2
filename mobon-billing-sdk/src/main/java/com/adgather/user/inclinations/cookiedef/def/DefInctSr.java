 ...
 *
 */
public class DefInctSr extends CookieDef {
	public DefInctSr(String cookieKey) {
		super(cookieKey);
	}
	...
	public int getExpire() {
		return PropertyHandler.getInt("COOKIE_INCT_SR_SHOPS_EXPIRE");
	}

	@Override
	public void infuseLimit(MemoryObj<?> memoryObj) {
		memoryObj.setMongoMaxCnt(PropertyHandler.getInt("MONGO_INCT_SR_SHOPS_COUNT"));
		memoryObj.setMongoMaxLen(PropertyHandler.getInt("MONGO_INCT_SR_SHOPS_BYTES"));
		memoryObj.setCookieMaxCnt(PropertyHandler.getInt("COOKIE_INCT_SR_SHOPS_COUNT"));
		memoryObj.setCookieMaxLen(PropertyHandler.getInt("COOKIE_INCT_SR_SHOPS_BYTES"));
	}
