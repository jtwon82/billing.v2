...
/**
 * @FileName : ABAdverStatsMobileKey.java
 * @Project : mobon-billing-dump
 * @Date : 2020. 3. 2. 
 * @Author dkchoi
 * @Comment : AB_ADVER_STATS_MOBILE 도메인 Key
 */
...
@EqualsAndHashCode
@Embeddable
public class ABAdverStatsMobileKey implements Serializable {

    /**
     *
     */
    private static final long serialVersionUID = 8436535515187658023L;
