...
/**
 * @FileName : ABAdverStatsMobileRepository.java
 * @Project : mobon-billing-dump
 * @Date : 2020. 3. 2. 
 * @Author dkchoi
 * @Comment : AB_ADVER_STATS_MOBILE 테이블용 Repository.
 */
@Repository
public interface ABAdverStatsMobileRepository extends JpaRepository<ABAdverStatsMobile, ABAdverStatsMobileKey> {
