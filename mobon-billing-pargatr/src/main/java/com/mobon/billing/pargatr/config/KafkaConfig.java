package com.mobon.billing.pargatr.config;
...
import com.mobon.billing.pargatr.handler.KafkaErrorHandler;
...
//		factory.getContainerProperties().setGenericErrorHandler(new KafkaErrorHandler());
