...
import com.mobon.billing.pargatr.handler.ContextClosedHandler;
							...
							if( contextClosedHandler.closed ) {
								...
								if( G.ParGatrData.equals( topic ) ) {
									try {
										...
										ConsumerFileUtils.writeLine( logPath +"retryfail/", writeFileName, G.ParGatrData, jJSONObject);
									}
								}
							}
						}
