...
public class ConsumerTopicReTry{
	...
	@Autowired
	private ContextClosedHandler	handler;
	...
	public void  processTopicFile() {
		...
		logger.info("ConsumerTopicRetry method in");
...
//		String fileName_prepix = "kafka-consumer.logging.log.topic";
//		String fileName_prepix = "conversion.frameid";
//		String fileName_prepix = "clickview.frameid.06050401.log";
		String file_reName = "";
...
//					file_reName = readFile.getAbsolutePath();
					...
					if (file_Tmp.isFile()) {
						...
						try {
							...
							fr = new BufferedReader(new InputStreamReader(new FileInputStream(file_Tmp),"euc-kr"));


//							fr = new BufferedReader(new FileReader(file_Tmp), "euc-kr");
//							
							while ((lineData = fr.readLine()) != null && !handler.closed) {
							...
							logger.info("lineDataSub {}", lineDataSub);
