package com.mobon.billing.sample.handler;
...
import com.mobon.billing.sample.schedule.TaskRetryData;
import com.mobon.billing.sample.schedule.TaskSampleVo;
...
public class ContextClosedHandler
	...
	public void onApplicationEvent(ContextClosedEvent event) {
		...
		try {
			...
			// for
			taskSampleVo.mongoToFileSampleVo();
	...
	public boolean chkRetryProcess() {
		...
		// 처리 Thread 수
		threadCnt = TaskSampleVo.getThreadCnt();
		...
		///// sumObject check
		int sumObjCnt = 0;
		Map<String, SampleVo> mapSampleVo = sumObjectManager.getMapSampleVo();

		sumObjCnt += mapSampleVo.size();
